		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PR PO Release Application",
									"targetURL": "#PRPOReleaseApplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PRPOReleaseApplication-display": {
								"semanticObject": "PRPOReleaseApplication",
								"action": "display",
								"description": "Application to Release PR and PO",
								"title": "PR PO Release Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.shell.popr.prporel",
									"url": sap.ui.require.toUrl("com/shell/popr/prporel")
								}
							}
						}
					}
